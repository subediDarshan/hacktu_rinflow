        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="https://www.npmjs.com/package/rinflow" target='_blank' className="text-slate-600 hover:text-slate-900 transition">Documentation</a>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <div className="relative group">
                ...
                <button onClick={() => nav("/signup")} className="relative bg-slate-900 text-white px-8 py-3 rounded-lg hover:bg-slate-800 transition">
                  Start Free Trial
                </button>
              </div>
            ...
            <div className="pt-8">
              <div className="flex items-center justify-center space-x-6">
                <div className="flex items-center">
                  <div onClick={copyToClipboard} className="flex items-center px-4 py-2 bg-slate-100 rounded-lg cursor-pointer hover:bg-slate-200 transition">
                    <code className="text-sm font-mono text-slate-700">npm i rinflow</code>
                    {copied ? (
                      <svg className="ml-2 h-4 w-4 text-green-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <polyline points="20 6 9 17 4 12" />
                      </svg>
                    ) : (
                      <svg className="ml-2 h-4 w-4 text-slate-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <a href="https://github.com" className="flex items-center text-slate-600 hover:text-slate-900 transition">
